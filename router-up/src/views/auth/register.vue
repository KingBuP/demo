  ...
  <div>
    <section class="min-h-screen flex items-stretch text-white">
      <div
        ...
        style="background-image: url(/images/wallhaven-g8l1r3.jpg)"
      >
        <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
        <div class="w-full px-24 z-10">
          <h1 class="text-5xl font-bold text-left tracking-wide">CL</h1>
          <p class="text-3xl my-4">
            杏 <span class="text-xs"> -友情出演</span>
          </p>
        </div>
        <div
        ...
        >
          <!-- 左下图片 -->
          <a href="javascript:;"
            ><i class="fab fa-qq text-2xl text-cyan-600"></i
          ></a>
          <a href="javascript:;"
            ><i class="fab fa-weibo text-2xl text-cyan-600"></i
          ></a>
          <a href="javascript:;"
            ><i class="fab fa-weixin text-2xl text-cyan-600"></i
          ></a>
        </div>
      </div>
      <div
        class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0"
        style="background-color: #1d2427"
      >
        <div
        ...
        <div class="w-full py-6 z-20">
          <h1 class="my-6 text-5xl">用户登录</h1>
          ...
          <p class="text-gray-100 text-xl">使用电子邮件或账户</p>
          <Form
          ...
          >
            <div class="pb-2 pt-4 relative">
              <Field
                ...
                value="admin888@qq.com"
              />
              <ErrorMessage
                name="email"
                class="absolute -bottom-3 left-5 text-xs text-orange-500"
              />
            </div>
            <div class="pb-2 pt-4 relative">
              <Field
...
const schema = {
  email: v.yup.string().required().email().label("邮箱"),
  password: v.yup.string().min(6).required().label("密码"),
};
...
<script lang="ts">
export default {
  route: { name: "login-2", meta: { guest: true } },
};
</script>
